...
**File Format:** Json save character stats and account of player or just save it all in the database(MySQL).

**(strech goal)Particle system:** contain four different particle effects which will used by certain characters in the game. The particles will be controlled with things such as their size, brightness, lifespan, speed, rotation, duration and maximum amount of particles.
